...
public class JavaorderControllerManager{
    ...
    private UriInfo oApplicationUri;
	    ...
	    public JavaorderModel postorder(JavaorderModel oJavaorderModel){
	        PostorderHandler oPostorderHandler = new PostorderHandler(oJavaorderModel, oApplicationUri);
	...
	@GET
	@Produces("application/JSON")
    public JavaorderModelManager getorderList(){
        GetorderListHandler oGetorderListHandler = new GetorderListHandler(oApplicationUri);
