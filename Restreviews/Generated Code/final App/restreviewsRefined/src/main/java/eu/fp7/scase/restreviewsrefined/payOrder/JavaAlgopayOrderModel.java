...
package eu.fp7.scase.restreviewsrefined.payOrder;
...
/* JavaAlgopayOrderModel class is responsible to model any data the payOrder resource handles. Since this one 
 is not automatable, the developer has to manually define it by providing its properties and setter/getter functions.*/
public class JavaAlgopayOrderModel{

    /* There follows a list with the properties that model the payOrder resource, as prescribed in the service CIM*/
