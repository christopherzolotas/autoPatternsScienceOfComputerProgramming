...
public class ObservablePostorderproductHandler{
    ...
    public ObservablePostorderproductHandler(int orderId, JavaproductModel oJavaproductModel, UriInfo oApplicationUri){
