...
public class HibernateController{
	...
	public ArrayList<JavaproductObserver> getproductObservers(ArrayList<JavaproductObserver> SetOfJavaproductObservers){
        ...
        String strHibernateQuery = "FROM JavaproductObserver";
        Query hibernateQuery = hibernateSession.createQuery(strHibernateQuery);
        SetOfJavaproductObservers = new ArrayList(hibernateQuery.list());

        /* Commit and terminate the session*/
        hibernateTransaction.commit();
        hibernateSession.close();
        return SetOfJavaproductObservers;
    }

	public JavaproductObserver updateJavaproductObserver(JavaproductObserver oJavaproductObserver){
        ...
        /* Update the existing product of the database*/
        hibernateSession.update(oJavaproductObserver);

        /* Commit and terminate the session*/
        hibernateTransaction.commit();
        hibernateSession.close();
        return oJavaproductObserver;
    }

	public JavaproductObserver createJavaproductObserver(JavaproductObserver oJavaproductObserver){
        ...
        /* Insert the new product to database*/
        hibernateSession.save(oJavaproductObserver);
	...
	public JavaproductObserver deleteJavaproductObserver(JavaproductObserver oJavaproductObserver){
        ...
        /* Retrieve the existing product from the database*/
        oJavaproductObserver = (JavaproductObserver) hibernateSession.get(JavaproductObserver.class, oJavaproductObserver.getobserverId());

        /* Delete the existing product from the database*/
        hibernateSession.delete(oJavaproductObserver);
    ...
    public Set<JavaorderModel> getorderList(Set<JavaorderModel> SetOforderList){
        ...
        String strHibernateQuery = "FROM JavaorderModel";
        Query hibernateQuery = hibernateSession.createQuery(strHibernateQuery);
        SetOforderList = new HashSet(hibernateQuery.list());

        /* Commit and terminate the session*/
        hibernateTransaction.commit();
        hibernateSession.close();
        return SetOforderList;
    }
	public ArrayList<JavaorderObserver> getorderObservers(ArrayList<JavaorderObserver> SetOfJavaorderObservers){
        ...
        /* Retrieve the list of order resources that are needed.*/
        String strHibernateQuery = "FROM JavaorderObserver";
        Query hibernateQuery = hibernateSession.createQuery(strHibernateQuery);
        SetOfJavaorderObservers = new ArrayList(hibernateQuery.list());

        /* Commit and terminate the session*/
        hibernateTransaction.commit();
        hibernateSession.close();
        return SetOfJavaorderObservers;
    }

	public JavaorderObserver updateJavaorderObserver(JavaorderObserver oJavaorderObserver){
        ...
        /* Update the existing order of the database*/
        hibernateSession.update(oJavaorderObserver);

        /* Commit and terminate the session*/
        hibernateTransaction.commit();
        hibernateSession.close();
        return oJavaorderObserver;
    }

	public JavaorderObserver createJavaorderObserver(JavaorderObserver oJavaorderObserver){
        ...
        /* Insert the new order to database*/
        hibernateSession.save(oJavaorderObserver);
	...
	public JavaorderObserver deleteJavaorderObserver(JavaorderObserver oJavaorderObserver){
        ...
        /* Retrieve the existing order from the database*/
        oJavaorderObserver = (JavaorderObserver) hibernateSession.get(JavaorderObserver.class, oJavaorderObserver.getobserverId());

        /* Delete the existing order from the database*/
        hibernateSession.delete(oJavaorderObserver);
