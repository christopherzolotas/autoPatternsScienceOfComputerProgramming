...
package eu.fp7.scase.restreviews.searchProduct;
...
/* JavaAlgosearchProductModel class is responsible to model any data the searchProduct resource handles. Since this one 
 is not automatable, the developer has to manually define it by providing its properties and setter/getter functions.*/
public class JavaAlgosearchProductModel{

    /* There follows a list with the properties that model the searchProduct resource, as prescribed in the service CIM*/
